...
def main():
    ...
    variance_net_filepath = 'variance_net_balanced_' + filepath
    ...
    balanced_examples = create_balanced_examples(prepared_examples)
    ...
    if train_full_net:
        ...
        optimizer = AdamW(abz.nnet.fc5.parameters(), lr=1e-2)
...
def create_balanced_examples(prepared_examples):
